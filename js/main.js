(() => {
  ...
  const TRANSLATIONS = {
    en: {
      ...
      "meta.description": "AI Product Builder & Product Engineer. From idea → prototype → payments → production → real users. Telegram bots, SaaS, AI automation and payment systems. ~200k monthly users.",
      ...
      "hero.sub": "From idea → prototype → payments → production → real users.",
      "hero.cta": "View cases",
      "hero.card.role": "AI Product Builder",
      "hero.card.speech": "AI Product Builder and Product Engineer. AI-native development, payments, automation and shipping — from MVP to production users.",
      ...
      "proof.years": "years shipping bots, SaaS & payments",
      ...
      "path.y2023.body": "Built Telegram bots, automation, SaaS products and payment systems for clients and own products — real scope, not just years.",
      ...
      "process.step1.body": "Turn vague ideas into working products — rapid prototyping, MVP scope and feature priority.",
      "process.step2.title": "Engineering",
      "process.step2.body": "Build backend systems, APIs & integrations, databases and infrastructure.",
      ...
      "process.step4.body": "Use LLMs, agents and AI-native development to prototype faster and automate workflows.",
      "process.step5.title": "Launch & Growth",
      "process.step5.body": "Deploy to production, watch analytics, gather user feedback and iterate on what ships.",
      "about.kicker": "About",
      "about.title": "About me",
      "about.lede": "CEO with an engineering core. Product ownership end-to-end — rapid prototyping, MVPs, APIs & integrations, payments and production.",
      "about.card.title": "I run the product, not only the code",
      "about.card.body": "Built Telegram bots, automation, SaaS products and payment systems for clients and own products — not just years on a resume, but real product ownership. Python, Docker, PostgreSQL, Redis, Mini Apps and AI automation in production. Live systems, analytics and user feedback — not a demo stack.",
      ...
      "about.li3": "AI-native development, APIs & integrations, payments and SaaS when the job needs it.",
      "about.li4": "Rapid prototyping → MVP → user feedback → analytics → shipping.",
      "about.quote": "I work for results, not activity.",
      "about.phone.alt": "iPhone showing +$10 000 payment received from SotaAds LLC",
    },
    ru: {
      "meta.title": "Kriva Portfolio",
      "meta.description": "AI Product Builder и Product Engineer. От идеи → прототип → платежи → прод → реальные пользователи. Telegram-боты, SaaS, AI-автоматизация и платёжные системы. ~200k пользователей в месяц.",
      ...
      "hero.sub": "От идеи → прототип → платежи → прод → реальные пользователи.",
      "hero.cta": "Кейсы",
      "hero.card.role": "AI Product Builder",
      "hero.card.speech": "AI Product Builder и Product Engineer. AI-native development, платежи, автоматизация и shipping — от MVP до пользователей в проде.",
      ...
      "proof.years": "лет ботов, SaaS и платежей",
      ...
      "path.y2023.body": "Строил Telegram-ботов, автоматизацию, SaaS и платёжные системы для клиентов и своих продуктов — реальный scope, а не просто годы.",
      ...
      "process.step1.body": "Превращаю размытые идеи в рабочие продукты — rapid prototyping, MVP и приоритеты фич.",
      "process.step2.title": "Инженерия",
      "process.step2.body": "Строю бэкенд, APIs & integrations, базы данных и инфраструктуру.",
      ...
      "process.step4.body": "Использую LLM, агентов и AI-native development, чтобы быстрее прототипировать и автоматизировать.",
      "process.step5.title": "Запуск и рост",
      "process.step5.body": "Деплой в production, аналитика, user feedback и итерации по тому, что реально шипится.",
      "about.kicker": "Обо мне",
      "about.title": "Обо мне",
      "about.lede": "CEO с инженерным ядром. Product ownership под ключ — rapid prototyping, MVP, APIs & integrations, платежи и production.",
      "about.card.title": "Я веду продукт, а не только код",
      "about.card.body": "Строил Telegram-ботов, автоматизацию, SaaS и платёжные системы для клиентов и своих продуктов — не просто годы в резюме, а реальный product ownership. Python, Docker, PostgreSQL, Redis, Mini Apps и AI automation в проде. Живые системы, analytics и user feedback — не демо-стек.",
      ...
      "about.li3": "AI-native development, APIs & integrations, платежи и SaaS — когда задаче это нужно.",
      "about.li4": "Rapid prototyping → MVP → user feedback → analytics → shipping.",
